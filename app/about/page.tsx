        ...
        <div className="container-custom max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 md:order-1">
              <h1 className="mb-6 sm:mb-8 text-3xl sm:text-4xl md:text-5xl">{t('about.hero.name')}</h1>

              <p className="text-base sm:text-lg text-[#6b7280] mb-4 sm:mb-6">
                {t('about.hero.intro')}
              </p>

              <p className="text-lg sm:text-xl text-[#5A9AB4] font-semibold mb-6 sm:mb-8">
                {t('about.hero.mission')}
              </p>

              <p className="text-base sm:text-lg text-[#1f2937]">
      ...
      <section className="py-12 md:py-16 bg-[#FFFEFA]">
        <div className="container-custom max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {/* Education */}
            <div className="bg-[#F7F9F9] p-6 sm:p-8 rounded-xl">
              <h3 className="text-lg sm:text-xl font-bold text-[#5A9AB4] mb-4 sm:mb-6 text-center flex items-center justify-center gap-2">
            ...
            {/* Awards */}
            <div className="bg-[#F7F9F9] p-6 sm:p-8 rounded-xl sm:col-span-2 md:col-span-1">
              <h3 className="text-lg sm:text-xl font-bold text-[#5A9AB4] mb-4 sm:mb-6 text-center flex items-center justify-center gap-2">
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container-custom max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {/* Theory Informed */}
            <div className="bg-gradient-to-br from-[#F7F9F9] to-white p-6 sm:p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow border-2 border-[#F7F9F9]">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#5A9AB4]/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              ...
              <h3 className="font-bold text-[#5A9AB4] text-base sm:text-lg mb-2">{t('about.philosophy.theoryInformed')}</h3>
              <p className="text-[#6b7280] text-xs sm:text-sm">{t('about.philosophy.theoryInformedDesc')}</p>
            </div>
