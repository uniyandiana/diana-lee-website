      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container-custom max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Theory Informed */}
            <div className="bg-gradient-to-br from-[#F7F9F9] to-white rounded-xl shadow-sm hover:shadow-md transition-shadow border-2 border-[#F7F9F9] overflow-hidden">
              <div className="relative h-48 w-full">
                <Image
                  src="/images/Lecture on Social Innovation.jpg"
                  alt="Lecture on Social Innovation"
                  fill
            ...
            <div className="bg-gradient-to-br from-[#F7F9F9] to-white rounded-xl shadow-sm hover:shadow-md transition-shadow border-2 border-[#F7F9F9] overflow-hidden">
              <div className="relative h-48 w-full">
                <Image
                  src="/images/Workshop Delivery (Personality Dimensions).jpeg"
                  alt="Workshop Delivery - Personality Dimensions"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="bg-gradient-to-br from-[#F7F9F9] to-white rounded-xl shadow-sm hover:shadow-md transition-shadow border-2 border-[#F7F9F9] overflow-hidden">
              <div className="relative h-48 w-full">
                <Image
                  src="/images/Lego play with students (game).jpg"
                  alt="Experiential learning with students"
                  fill
                  className="object-cover"
                />
              </div>
            ...
            <div className="bg-gradient-to-br from-[#F7F9F9] to-white rounded-xl shadow-sm hover:shadow-md transition-shadow border-2 border-[#F7F9F9] overflow-hidden">
              <div className="relative h-48 w-full">
                <Image
                  src="/images/Design Thinking Workshop for NGO.jpeg"
